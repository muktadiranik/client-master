...
const localDevWebpackConfig = merge(baseWebpackConfig, {
  mode: 'development',
  module: {
...
module.exports = new Promise((resolve, reject) => {
  ...
  portfinder.getPort((err, port) => {
    if (err) {
      ...
      localDevWebpackConfig.devServer.port = port
      localDevWebpackConfig.plugins.push(new FriendlyErrorsPlugin({
        compilationSuccessInfo: {
          messages: [`Your application is running here: http://${localDevWebpackConfig.devServer.host}:${port}`],
        },
