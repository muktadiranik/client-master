      ...
      <ValidationObserver ref="observer" v-slot="{ validate, valid }">
        <div class="c-modal__inner u-br-3">
          <div class="c-modal__header">
            <h6 class="o-h6 u-color-white u-font-16">Delete Account Confirmation</h6>
            <button class="u-fs-20 u-cursor-pointer" @click="closeModal">
              <i class="fal fa-times"></i>
            </button>
          </div>
          <div class="c-modal__body">
            <p class="u-mb-20">Are you sure you want to delete your account? Please enter your password to confirm</p>
