...
import store from '@/stores/user-pending-transactions'
import { mapActions, mapState } from 'vuex'

export const UserPendingTransactionsMixin = {
  computed: {
    ...mapState(STORE_KEY, {
  ...
  methods: {
    ...mapActions(STORE_KEY, {
      actionLoadUserPendingTransactions: LOAD_TRANSACTIONS,
      actionLoadUserProfile: LOAD_USER_PROFILE,
      actionSetTransactionsQuery: SET_TRANSACTIONS_QUERY,
      actionResetUserPendingTransactionsStore: RESET_STORE,
