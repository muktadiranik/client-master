...
import store from '@/stores/user-profile-transactions'
import { mapActions, mapState } from 'vuex'

export const UserProfileTransactionsMixin = {
  computed: {
    ...mapState(STORE_KEY, {
  ...
  methods: {
    ...mapActions(STORE_KEY, {
      ...
      actionSetTransactionsTitleQuery: SET_TRANSACTIONS_TITLE_QUERY,
    }),
  },
  created() {
