  ...
  <div class="section-vulnerability-type">
    <div class="u-position-relative">
      <div class="c-input-icon c-input-icon--sm c-input-icon--left">
        ...
        <i class="far fa-times-circle c-clear-input__icon" v-bind:style="{right : '3em'}" @click="clearSearchText()" v-show="inputText !== ''"></i>
      </div>
    </div>
  </div>
</template>
