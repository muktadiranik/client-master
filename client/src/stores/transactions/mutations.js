...
export default {
  [SET_FILTER_OPTION]: (state, payload) => {
    ...
    localStorage.setItem('transactionsListFilterOption', JSON.stringify(payload))
  },
  [SET_SORT_OPTION]: (state, payload) => {
    ...
    localStorage.setItem('transactionsListSortOption', JSON.stringify(payload))
    localStorage.setItem('transactionsListSortOrder', state.sortOrder)
  },
