...
export const mutations = {
  [SET_FILTER_OPTION]: (state, payload) => {
    ...
    localStorage.setItem('userPendingTransactionsListFilterOption', JSON.stringify(payload))
  },
  [SET_SORT_OPTION]: (state, payload) => {
    ...
    localStorage.setItem('userPendingTransactionsListSortOption', JSON.stringify(payload))
    localStorage.setItem('userPendingTransactionsListSortOrder', state.sortOrder)
  },
