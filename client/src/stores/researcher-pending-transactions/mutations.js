...
export const mutations = {
  [SET_FILTER_OPTION]: (state, payload) => {
    ...
    localStorage.setItem('researcherPendingTransactionsListFilterOption', JSON.stringify(payload))
  },
  [SET_SORT_OPTION]: (state, payload) => {
    ...
    localStorage.setItem('researcherPendingTransactionsListSortOption', JSON.stringify(payload))
    localStorage.setItem('researcherPendingTransactionsListSortOrder', state.sortOrder)
  },
  ...
  [SET_TRANSACTIONS_QUERY_TITLE]: (state, payload) => {
